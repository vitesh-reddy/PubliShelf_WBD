...
const ManagerSignup = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await signupUser({ role: "manager", firstname, lastname, email, password });
  ...
  const handleVerifyOtp = async (otp) => {
    ...
    try {
      const response = await verifyOtp({ email: otpEmail, otp, role: "manager", purpose: "signup" });
  ...
  const handleResendOtp = async () => {
    ...
    try {
      const response = await resendOtp({ email: otpEmail, role: "manager", purpose: "signup" });
