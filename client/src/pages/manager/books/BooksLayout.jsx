...
const BooksLayout = () => {
  ...
  const tabs = [
    { path: "/manager/books/pending", label: "Pending" },
    { path: "/manager/books/approved", label: "Approved" },
    { path: "/manager/books/rejected", label: "Rejected" },
    { path: "/manager/books/flagged", label: "Flagged" },
  ];
