// client/src/pages/manager/components/ManagerNavbar.jsx
...
const ManagerNavbar = ({ managerName }) => {
  ...
  const navLinks = [
    ...
    // { path: '/manager/books', label: 'Books', icon: 'fa-book' }, // temporarily disabled
          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="relative group">
              <button className="flex items-center gap-2 text-gray-700 hover:text-purple-600 transition-colors">
                ...
                <span className="font-[550]">{managerName}</span>
              </button>
